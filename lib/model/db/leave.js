...
var
    ...
    employee_comment_char_limit = 23;
...
has_employee_comment: function () {
  return this.employee_comment !== ''
},

employee_comment_larger_than_limit: function(){
  return this.employee_comment.length > employee_comment_char_limit
},
